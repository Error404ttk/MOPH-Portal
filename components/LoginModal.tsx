...
import { Lock, User, KeyRound, X, Loader2 } from 'lucide-react';
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="pt-4">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 bg-moph-600 hover:bg-moph-700 text-white rounded-xl font-semibold shadow-md shadow-moph-500/20 transition-colors flex items-center justify-center disabled:opacity-50"
              disabled={isLoading}
            >
                {isLoading ? (
