...
const AboutSection: React.FC<{ abouts: About[] }> = ({ abouts }) => {
  const first = abouts && abouts.length > 0 ? abouts[0] : null;
  return (
    <section className="py-12 mt-8 border-t border-gray-100">
      <div className="flex items-center gap-3 mb-8">
        <div className="h-8 w-1.5 bg-indigo-500 rounded-full"></div>
        <h2 className="text-2xl md:text-3xl font-bold text-gray-800">{first?.title || 'เกี่ยวกับกระทรวงสาธารณสุข'}</h2>
      </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 h-full">
            <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
              ...
              {first?.title || 'ภาพรวมองค์กร'}
            </h3>
            <p className="text-gray-600 leading-relaxed mb-8 text-lg">
              {first?.content || 'กระทรวงสาธารณสุข (MOPH) เป็นองค์กรหลักด้านสุขภาพของประเทศไทย มีหน้าที่ในการสร้างเสริมสุขภาพ ป้องกันควบคุมโรค รักษาพยาบาล และฟื้นฟูสมรรถภาพของประชาชน เพื่อให้ประชาชนมีสุขภาพดีและเข้าถึงบริการทางแพทย์ได้อย่างเท่าเทียม'}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <div>
                    ...
                    <p className="text-indigo-700/80">"โรงพยาบาลสารภีมีความปลอดภัยได้มาตรฐาน มีบริการเป็นเลิศ ประสานเครือข่าย สร้างสรรค์นวตกรรมนำสู่สากล
"</p>
                </div>
                </div>
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 h-full">
            ...
            <div className="space-y-4">
              <a href="https://sarapeehospital.go.th/" target="_blank" rel="noopener noreferrer" 
                ...
                <span className="text-slate-700 group-hover:text-moph-700 font-medium">เว็บไซต์หลักโรงพยาบาลสารภี</span>
              </a>
              <a href="https://sarapeehospital.go.th/about/history" target="_blank" rel="noopener noreferrer"
               ...
               <a href="https://sarapeehospital.go.th/about/executive" target="_blank" rel="noopener noreferrer"
              ...
              <a href="https://sarapeehospital.go.th/contact" target="_blank" rel="noopener noreferrer"
